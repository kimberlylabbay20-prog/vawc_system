...
class Report(Base):
    ...
    assigned_officer = relationship("User", back_populates="assigned_cases", foreign_keys=[assigned_to])
    activities = relationship("CaseActivity", back_populates="case", foreign_keys="CaseActivity.case_id")
    notifications = relationship("Notification", back_populates="case", foreign_keys="Notification.case_id")
    referrals = relationship("Referral", back_populates="case", foreign_keys="Referral.case_id")
